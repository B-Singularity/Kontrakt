...
> * `../compiler-engine/l1-planner-session-primitive-data-structures.md`
> * `../compiler-engine/l2-plan-interner-partitioned-tier2-with-governance.md`
> * `../runtime/planner-budget-resolution-and-worker-lifecycle.md`
>
