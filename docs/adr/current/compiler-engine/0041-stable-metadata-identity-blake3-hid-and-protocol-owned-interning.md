...
`../../../design/infrastructure/stable-metadata-identity-protocol.md` owns the extracted maintenance surface for
byte-level metadata
identity protocol.
...
`../../../design/infrastructure/protocol-owned-metadata-interning.md` owns the extracted maintenance surface for
metadata interning
semantics.
