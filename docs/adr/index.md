...
| ADR                                                                                                                          | Title                                                                          | Status   |
|------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|----------|
| [ADR-0072](current/contract/data-model/0072-input-collection-presentation-aggregate-semantics-and-deterministic-equality.md) | Input Collection Presentation, Aggregate Semantics, and Deterministic Equality | Proposed |
