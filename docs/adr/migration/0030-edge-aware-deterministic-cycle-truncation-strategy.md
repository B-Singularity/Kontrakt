...
(AMENDED): [ADR-0032](../current/runtime/0032-capacity-law-resource-policy-resolution-identity-hierarchy-and-zero-residue-semantics.md), [ADR-0037](0037-cycle-identity-preflight-and-deferred-raw-fact-resolution.md)
...
* Examples: [cycle-truncation-examples](../../design/frontend/cycle-truncation-examples.md)
