...
| ID     | Characteristic               | Ownership     | Meaning                                                                        | Difference from nearby characteristics                                                                       |
|--------|------------------------------|---------------|--------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| `D031` | **Measurement Model**        | `CT→ / R`     | Model relating observed inputs to the quantity or state being inferred.        | Distinct from raw evidence: a model explains how observation becomes a measurement result.                   |
