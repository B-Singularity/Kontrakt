...
interface ClasspathScanner {
     ...
     * @throws stage.input.diagnostics.RuntimeIntegrityException If the environment is corrupted.
     * @throws stage.input.diagnostics.DiscoveryFailedException If user order violations are found.
     */
