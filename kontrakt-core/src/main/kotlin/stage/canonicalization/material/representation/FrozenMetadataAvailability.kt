 ...
 *
 * Availability is records state, not primary identity-key material.
 *
 ...
 * - lazy delegates.
 *
 * If a containing records needs diagnostic detail, that detail must be carried
 ...
 * records key equality, route64, PlanCacheKey, canonical IR lowering, or L2
