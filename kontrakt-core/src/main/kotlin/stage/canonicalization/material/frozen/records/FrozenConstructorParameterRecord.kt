...
/**
 * Frozen constructor-parameter records.
 *
 ...
 * ```
 *
 * [parameterName] is deliberately records payload, not key material.
 *
 * Rationale:
 *
 ...
 * deterministic token before this records is issued. That token must not encode:
 *
 * - object identity;
 * - registry id;
 ...
 *
 * This records does not validate that [parameterType] belongs to a particular
 * FrozenMetamodelImage.
 *
 * Reason:
 *
 * A single parameter records is image-agnostic. It does not own the type index,
 ...
 *
 * This records can validate only local key shape.
 *
 ...
 * Availability law:
 *
 * [declarationAvailability] is records state.
 *
