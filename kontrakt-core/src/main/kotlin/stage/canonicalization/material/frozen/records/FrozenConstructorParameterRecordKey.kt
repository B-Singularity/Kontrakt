 ...
 * - parameterName is records payload/state;
 * - parameterName must still be lowered deterministically and validated by the
 *   records, but it must not decide key equality.
 *
 * Parameter-index law:
 *
 ...
 *
 * This Level 1 object-records key keeps [ownerConstructorKey] as an object
 * reference.
 *
