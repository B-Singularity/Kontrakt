...
/**
 * Frozen property records.
 *
 * This is the Level 1 frozen object-records representation for one property
 ...
 *
 * Property-level [annotationRecords] are attached to this property records, but
 * the current FrozenAnnotationRecordKey does not yet carry an explicit owner
 * property key.
 *
 * Therefore this records cannot locally prove that every nested annotation
 * records belongs to this property.
 *
