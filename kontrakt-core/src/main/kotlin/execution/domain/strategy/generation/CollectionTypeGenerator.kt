...
class CollectionTypeGenerator : RecursiveGenerator {
    ...
    private fun createInstance(
        ...
        val kClass =
            request.type.classifier as? KClass<*>
        ...
        return when {
            ...
            Queue::class.java.isAssignableFrom(javaClass) ||
                Deque::class.java.isAssignableFrom(javaClass) ->
                LinkedList(generateList(request, context, size, regenerator))
