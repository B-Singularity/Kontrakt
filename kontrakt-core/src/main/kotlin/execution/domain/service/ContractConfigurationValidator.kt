...
object ContractConfigurationValidator {
    ...
    private val VALUE_CONSTRAINTS = setOf(
        AssertTrue::class, AssertFalse::class,
        IntRange::class, LongRange::class, DoubleRange::class,
        DecimalMin::class, DecimalMax::class, Digits::class,
        Positive::class, PositiveOrZero::class, Negative::class, NegativeOrZero::class,
        StringLength::class, NotBlank::class, Pattern::class,
        Email::class, Url::class, Uuid::class,
        Past::class, PastOrPresent::class, Future::class, FutureOrPresent::class,
        Size::class, NotEmpty::class
    )
