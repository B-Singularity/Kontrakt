    ...
    private fun resolveRawClass(type: Type): Class<*> {
        return when (type) {
            ...
            is GenericArrayType -> {
                ...
                java.lang.reflect.Array.newInstance(componentRaw, 0).javaClass
            }
...
data class JvmClassHandle(val clazz: Class<*>) : RuntimeTypeHandle