...
class StringGenerator(
    ...
    override fun generateEdgeCases(context: GenerationContext): List<String> =
        buildList {
...
class URLGenerator(
    ...
    private fun genSegment(r: Random): String {
        val chars = "abc123-_"
...
class EmailGenerator(
    ...
    private fun generateSimpleAccount(
        r: Random,
        maxLen: Int,
    ): String {
    ...
    private fun generateDottedAccount(
        r: Random,
        maxLen: Int,
    ): String {
    ...
    private fun generatePlusAccount(
        r: Random,
        maxLen: Int,
    ): String {
        if (maxLen < 3) return "a+b"
...
class UUIDGenerator : Generator<UUID> {
    override fun generate(context: GenerationContext) =
        UUID(context.seededRandom.nextLong(), context.seededRandom.nextLong())
}
