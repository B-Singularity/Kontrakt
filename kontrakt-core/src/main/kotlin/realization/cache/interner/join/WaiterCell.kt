package realization.cache.interner.join
 ...
 *
 * - bits `0..1` : [statemachine.state.material.condition.WaiterState] code
...
internal class WaiterCell private constructor(
     ...
     * ## Enforcement model
     *
     * [statemachine.transition.contract.L2LifecycleLaw.requireTransition] is used here as a **fixed legal-edge assertion**:
