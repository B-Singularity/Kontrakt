package metamodel.adapter.normalization

import com.ibm.icu.lang.UCharacter
import com.ibm.icu.lang.UCharacterCategory
import com.ibm.icu.text.Normalizer2
import com.ibm.icu.util.VersionInfo
import metamodel.adapter.normalization.Icu4jNormalizationEngineAdapter.Companion.MAX_RETAINED_SCRATCH_CODE_POINTS
import metamodel.adapter.normalization.Icu4jNormalizationEngineAdapter.Companion.SCRIPT_POLICY_KONTRAKT_TYPE_TEXT_V1
...
/**
 * ICU4J-backed implementation of [NormalizationEngine].
 *
 * This is an adapter.
 *
 * The metamodel domain owns the [NormalizationEngine] port and the canonical
 ...
 *
 * This adapter follows the order required by [NormalizationEngine]:
 *
 * 1. read input length;
 * 2. early length cap;
 * 3. snapshot capture;
