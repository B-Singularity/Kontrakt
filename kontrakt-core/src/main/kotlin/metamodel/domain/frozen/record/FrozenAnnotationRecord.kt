 ...
 *
 * This is the Level 1 frozen object-record representation for one annotation.
 *
 * It is intentionally still an object record:
 *
 ...
 * slabs, but this foundation cut keeps the semantic record explicit so the
 * frozen-record law can be validated before physical layout is compressed.
 *
 * Backend-erasure law:
 *
 ...
 * - later slab lowering removes object-record overhead without changing this
 *   semantic law.
 *
 ...
 * ```
 *
 * This prevents a record from being indexed as annotation A while carrying the
