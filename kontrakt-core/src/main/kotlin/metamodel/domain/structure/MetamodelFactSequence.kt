package metamodel.domain.structure

import metamodel.domain.exception.DuplicateMetamodelFactException
        ...
        fun <T> compactIndexedBy(
            ...
            buffer.sortWith(
                Comparator { left, right ->
                    java.lang.Integer.compare(indexOf(left), indexOf(right))
                },
            )
