...
object ProtocolGoldenVectors {
    ...
    val COST_CENTER_TRACES: List<CostCenterTraceVector> = listOf(
        // L1 dispatch / indexer
    ...
    private fun hexRepeat(byteHex: String, count: Int): String {
