package linking.domain.exception
...
abstract class LinkingException(
    ...
    protected fun freezeContext(originalContext: Map<String, Any?>): Map<String, Any?> {
        ...
        val cappedSnapshot: Map<String, Any?> = runCatching {
            originalContext.entries.asSequence()
        ...
        return try {
            ...
            mapOf(
                ...
                "value_types" to cappedSnapshot.entries.asSequence()
                    .mapIndexed { i, (k, v) ->
