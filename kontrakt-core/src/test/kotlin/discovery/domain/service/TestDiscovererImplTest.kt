...
private class ValidImplementation(
...
class TestDiscovererImplTest {
    @Test
    fun `should create specification for a valid class`() =
        runTest {
    ...
    @Test
    fun `shoulld skip class with no primary constructor`() =
        runTest {
    ...
    @Test
    fun `should return empty list when scanner finds nothing`() =
        runTest {
