...
class TimeTypeGeneratorTest {
    ...
    class TimeTestTargets {
        ...
        // --- Past Constraints ---
        fun pastStrict(@Past(value = 10, unit = ChronoUnit.SECONDS) arg: Instant) {}
        fun pastOrPresent(@PastOrPresent(value = 10, unit = ChronoUnit.SECONDS) arg: Instant) {}

        // --- Future Constraints ---
        fun futureStrict(@Future(value = 10, unit = ChronoUnit.SECONDS) arg: Instant) {}
        fun futureOrPresent(@FutureOrPresent(value = 10, unit = ChronoUnit.SECONDS) arg: Instant) {}
        ...
        fun invalidZone(@Past(value = 1, zone = "Mars/Colony") arg: Instant) {}
        fun negativeValue(@Future(value = -5) arg: Instant) {}
        fun invalidBaseFormat(@Past(base = "NotADate", value = 1) arg: Instant) {}
    }
