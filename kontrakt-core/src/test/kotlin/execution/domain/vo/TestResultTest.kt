...
class TestResultTest {
    ...
    private val assertionPass = AssertionStatus.PASSED
    private val assertionFailed = AssertionStatus.FAILED

    @Test
    fun `should create result with Passed status`() {
        val duration = Duration.ofMillis(100)

        val record = AssertionRecord(assertionPass, "All good", true, true)
    ...
    fun `should create result with AssertionFailed status`() {
        ...
        val record = AssertionRecord(assertionFailed, "Value mismatch", 10, 5)
